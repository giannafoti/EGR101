...
commonusername = ['kax2022', 'py_rules', 'TAsRcool', 'geauxtigahs!', 'chargersWin'] #common usernames list 
commonpassword = {'Abc!123', 'P4ssw0rd', 'birthDay%', 'Tacob&ll'} #common passwords set
...
if len(username) < 6: #checking if username is too short 
    ...
    print ('Your username is too long')
elif username in commonusername: #checking if username is in common usernames list
        ...
        if len(password) < 6: #checking if password is too short
        ...
        elif password in commonpassword: #checking if password is in common passwords set
            ...
            commonusername.append(username) #adding username to the used names list
